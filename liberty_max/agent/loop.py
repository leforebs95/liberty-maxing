...
from liberty_max.agent.subagent import SubagentManager
from liberty_max.agent.tools.cron import CronTool
from liberty_max.agent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
from liberty_max.agent.tools.message import MessageTool
from liberty_max.agent.tools.registry import ToolRegistry
from liberty_max.agent.tools.shell import ExecTool
from liberty_max.agent.tools.spawn import SpawnTool
from liberty_max.agent.tools.web import WebFetchTool, WebSearchTool
from liberty_max.bus.events import InboundMessage, OutboundMessage
from liberty_max.bus.queue import MessageBus
from liberty_max.providers.base import LLMProvider
from liberty_max.session.manager import Session, SessionManager

if TYPE_CHECKING:
    from liberty_max.config.schema import ChannelsConfig, ExecToolConfig
...
class AgentLoop:
    ...
    def __init__(
        ...
        from liberty_max.config.schema import ExecToolConfig
        self.bus = bus
    ...
    async def _connect_mcp(self) -> None:
        ...
        from liberty_max.agent.tools.mcp import connect_mcp_servers
        try:
