...
from liberty_max.cli import commands
...
def mock_prompt_session():
    ...
    with patch("liberty-max.cli.commands._PROMPT_SESSION", mock_session), \
         patch("liberty-max.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("liberty-max.cli.commands.PromptSession") as MockSession, \
         patch("liberty-max.cli.commands.FileHistory") as MockHistory, \
